...
function getExplorersByChain(chain, explorerAPIs) {
    ...
    switch (chain) {
        ...
        case blockchains_1.BLOCKCHAINS[supported_chains_1.SupportedChains.Ethgusandbox].code:
        case blockchains_1.BLOCKCHAINS[supported_chains_1.SupportedChains.Ethjoc].code:
